    ...
    <div className="h-full bg-white p-8 max-w-4xl mx-auto pb-32 md:pb-0">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          {selectedTime && date && (
            <div className="mt-8">
              <button className="w-full bg-[#4EA7A7] text-white py-3 rounded-lg hover:bg-[#4EA7A7]/90 transition-colors">
                Confirmar cita el {(date as Date).toLocaleDateString()} a las {selectedTime}
              </button>
            </div>
          )}
        </div>
